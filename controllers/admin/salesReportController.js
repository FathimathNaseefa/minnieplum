...
exports.getSalesReportData = async (req, res) => {
    try {
        ...
        console.log(`Fetching sales report for: ${startDate} to ${endDate}, Period: ${period}`);
...
exports.downloadPDF = async (req, res) => {
    try {
        ...
        doc.fontSize(12).text(`Date Range: ${moment(startDate).format("YYYY-MM-DD")} to ${moment(endDate).format("YYYY-MM-DD")}`, { align: "center" });
        doc.moveDown(2);
